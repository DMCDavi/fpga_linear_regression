//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=12 LPM_WIDTHB=14 LPM_WIDTHP=26 LPM_WIDTHS=1 MAXIMIZE_SPEED=6 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_be01
	...
	wire	[15:0]	wire_sum_adder1aa_5result_int;
	...
	assign
		wire_sum_adder1aa_5result = wire_sum_adder1aa_5result_int[15:1];
	assign
	...
	assign
		wire_sft10a_in = {w297w, {w297w, {w297w, {w297w, {(~ w_sum_node10w[47]), {w287w, {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {2{w297w}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w297w, {w_sum_node10w[46], {(~ w_sum_node10w[31]), {w287w, {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81:80]}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w297w, {w297w, {w297w, {w_sum_node10w[44], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25:24]}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w297w, {w297w, {w297w, {w297w, {w287w, {w297w, {w297w, {w297w, {2{w297w}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft3a_in = {w287w, {(~ w_sum_node10w[95]), {w_sum_node10w[94], {(~ w_sum_node10w[79]), {w287w, {w_sum_node10w[91], {w_sum_node10w[62], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[45], {w_sum_node10w[30], {(~ w_sum_node10w[15]), {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft8a_in = {w297w, {w_sum_node10w[78], {(~ w_sum_node10w[63]), {w287w, {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49:48]}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w297w, {w297w, {w297w, {w_sum_node10w[90], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35:34]}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[13:0]},
		datab_node = {dataa[11:0]},
		final_result_node = {w509w[25:0]},
		result = {final_result_node[25:0]},
		w287w = 1'b1,
		w297w = 1'b0,
		w509w = {wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
