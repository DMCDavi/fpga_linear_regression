...
module  mult_vc01
	...
	assign
		wire_sft10a_in = {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {2{w160w}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft3a_in = {w142w, {wire_sft11a_out[14], {w142w, {w142w, {(~ w_sum_node10w[15]), {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w160w, {w160w, {w_lone_sum_node11w[13], {(~ w_lone_sum_node11w[12]), {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18], {w_sum_node10w[17:16]}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w160w, {w160w, {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {2{w160w}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w160w, {(~ w_sum_node10w[31]), {w_sum_node10w[30], {w142w, {w_sum_node10w[14], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], w142w}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w160w, {w160w, {w160w, {(~ w_lone_sum_node11w[11]), {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, {w160w, (~ w_lone_sum_node11w[0])}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[13:0]},
		datab_node = {dataa[4:0]},
		final_result_node = {w291w[18:0]},
		result = {final_result_node[18:0]},
		w142w = 1'b1,
		w160w = 1'b0,
		w291w = {wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[13:0]} & {14{w_le_datab_node8w[4]}}), ({dataa_node[13:0]} & {14{w_le_datab_node8w[3]}}), ({dataa_node[13:0]} & {14{w_le_datab_node8w[2]}}), ({dataa_node[13:0]} & {14{w_le_datab_node8w[1]}}), ({dataa_node[13:0]} & {14{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[4:0]},
		w_lone_sum_node11w = {w_decoder_node9w[69:56]},
		w_sum_node10w = {wire_sum_adder1aa_1result[14:0], w_decoder_node9w[28], wire_sum_adder1aa_0result[14:0], w_decoder_node9w[0]};
endmodule //mult_vc01
//VALID FILE
